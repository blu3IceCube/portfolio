    ...
    <div className="py-16 lg:py-24">
      <div className="container">
        <SectionHeader
          ...
          description="Don't just take my word fot it. See what my clients have to say about my
        work."
        />
            ...
            {testimonials.map((testimonial) => (
              ...
              >
                <div className="flex gap-4 items-center">
                  <div className="size-14 inline-flex items-center justify-center bg-gray-700 rounded-full flex-shrink-0">
                    <Image
